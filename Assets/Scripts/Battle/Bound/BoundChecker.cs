...
public static class BoundChecker 
{
    ...
    public static (string ret_bound, bool ret_check) BoundCheck(int actorNum)
    {
      ...
      //      Overmind.Instance.CallRPCJuju_Starter(actorNum, curBound, check);
        }
        else
        {
    ...
    public static void After_CallRPCJuju(int actorNum)
    {
        var playerData = Overmind.Instance.players[actorNum];
