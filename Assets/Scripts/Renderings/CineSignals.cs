...
public class CineSignals : MonoBehaviour
{
    ...
    public void Alisha_Anim_Spawn()
    {
        ...
        foreach (var chargo in dic.Values)
        {
            ...
            animatortt.SetTrigger("Trig_GameStart");
    ...
    {
        if (ctx == null) { Debug.LogError("[CineSignals]  참조가 없음 그래서 못움직임"); return; }
