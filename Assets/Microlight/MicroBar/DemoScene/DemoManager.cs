...
namespace Microlight.MicroBar {
    public class DemoManager : MonoBehaviour {
     ...
     // [SerializeField] MicroBar Simple_MicroBar;
        ...
        [SerializeField] MicroBar Delayed_MicroBar_char;

        [Header("Health Bar Holders")]
        [SerializeField] Transform leftBarHolder;

        [SerializeField] Transform UIBarHolder;
        [SerializeField] Transform mycharBarHolder;
        [SerializeField] Transform opcharBarHolder;
        //      
     ...
     //   [SerializeField] Text soundButtonText;
        ...
        public void DamageMe(int newHP)
        {
            ...
            // Update HealthBar
            if (UIMicroBar != null) UIMicroBar.UpdateBar(myHp, false, UpdateAnim.Damage);
            if (myCharMicroBar != null) myCharMicroBar.UpdateBar(myHp, false, UpdateAnim.Damage);
        ...
        public void DamageOp(int  newHP)
        {
            ...
            // Update HealthBar
            if (opCharMicroBar != null) opCharMicroBar.UpdateBar(opHp, false, UpdateAnim.Damage);
            //leftAnimator.SetTrigger("Damage");
        }
       ...
       //     leftAnimator.SetTrigger("Heal");
        ...
        void ChangeBars() {
              ...
              //      rightMicroBar = Instantiate(Simple_MicroBar, rightBarHolder);
                ...
                case 1:
                   // leftMicroBar = Instantiate(Delayed_MicroBar, leftBarHolder);
                     ...
                     UIMicroBar = Instantiate(Delayed_MicroBar, UIBarHolder); ;
                     myCharMicroBar = Instantiate(Delayed_MicroBar_char, mycharBarHolder); ;
                     opCharMicroBar = Instantiate(Delayed_MicroBar_char, opcharBarHolder); ;
            ...
            if (UIMicroBar != null) UIMicroBar.Initialize(MAX_HP);

            if (myCharMicroBar != null) myCharMicroBar.Initialize(MAX_HP);

            if (opCharMicroBar != null) opCharMicroBar.Initialize(MAX_HP);
